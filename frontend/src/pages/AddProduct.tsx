    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center gap-4">
          <Button icon={<ArrowLeft size={18} />} onClick={() => navigate('/products')} />
          <div>
        ...
        <div className="flex gap-3">
          ...
          <Button type="primary" icon={<Save size={18} />} onClick={handleSave} className="bg-[#d32f2f] hover:bg-[#ba1a20]">
            Save Product
          </Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white border border-[#d8dadc] rounded-lg shadow-sm p-6 flex flex-col gap-4">
            <h2 className="text-lg font-semibold text-[#191c1e] mb-2 border-b border-[#eceef0] pb-2">General Information</h2>
          ...
          <div className="bg-white border border-[#d8dadc] rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold text-[#191c1e] mb-4 border-b border-[#eceef0] pb-2">Pricing & Inventory</h2>
